...
## Project Structure
    ...
    ├── volunteer_with_gids_42127  # Django project configurations
...
1. Clone this repo and `cd volunteer_with_gids_42127`
...
2. Clone this repo and `cd volunteer_with_gids_42127`
